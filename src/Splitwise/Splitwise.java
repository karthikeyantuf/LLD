...
public class Splitwise {
    ...
    public  void demo()
    {
        ...
        splits.add(split2);
        splits.add(split3);
        group.createExpense("Exp1001", "Breakfast", 900.00, ExpenseSplitType.EQUAL, userController.getUser("U1001"),splits);
        ...
        group.createExpense("Exp1002", "Lunch", 500.00,ExpenseSplitType.UNEQUAL, userController.getUser("U2001"),splits2);
